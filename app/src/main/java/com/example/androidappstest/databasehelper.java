...
public class databasehelper extends SQLiteOpenHelper{
    ...
    public void updateData(String row_id, String nama, String alamat, String nik, String tempat_lahir, String tanggal_lahir, String agama, String nomor_telepon, String kepala_keluarga) {
    ...
    public void addData(String namaTxt, String alamatTxt, String nikTxt, String tempatLahirTxt, String tanggalLahirTxt, String agamaTxt, String teleponTxt) {
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues cv = new ContentValues();

        cv.put(COLUMN_NAMA, namaTxt);
        cv.put(COLUMN_ALAMAT, alamatTxt);
        cv.put(COLUMN_NIK, nikTxt);
        cv.put(COLUMN_TEMPAT_LAHIR, tempatLahirTxt);
        cv.put(COLUMN_TANGGAL_LAHIR, tanggalLahirTxt);
        cv.put(COLUMN_AGAMA, agamaTxt);
        cv.put(COLUMN_TELEPON, teleponTxt);
